...
from pygame import *
#from tkinter import *
#from tkinter.colorchooser import * # Search for "askcolor"
...
async def main():
    global calibriSmall, calibriNorm, calibriBig, calibriBold, screen, mushroom, mushroom, mx, my, mxStart, myStart
    global spacePic, origSmgLogo, paintPic, orig_mario_paint, orig_babyLuma_paint, spacePic, smgLogo, paintPic, mario_paint, babyLuma_paint
    global canvas, undoScreens, redoScreens, add, clearAdd, take, cutting, copying, pasting, saveAsIcon
    global undoIcon, redoIcon, newIcon, openIcon, loadIcon, cutIcon, copyIcon, clearIcon, pencilIcon, markerIcon
    global eraserIcon, dropperIcon, bucketIcon, sprayPaintIcon, calligraphyIcon, saveRect, undoRect, redoRect, newRect, openRect
    global loadRect, cutRect, copyRect, clearRect, pencilRect, markerRect, eraserRect, dropperRect, bucketRect, sprayPaintRect
    global textRect, calligraphyRect, fillRect, fillToggler, lineRect, rectRect, ellipseRect, polygonRect, icons, iconScales
    global blitIcons, iconRects, rialBig, textPic, saveAsRectCopy, saveRectCopy, undoRectCopy
    global redoRectCopy, newRectCopy, openRectCopy, loadRectCopy, cutRectCopy, copyRectCopy, clearRectCopy, pencilRectCopy, markerRectCopy, eraserRectCopy
    global dropperRectCopy, bucketRectCopy, sprayPaintRectCopy, textRectCopy, calligraphyRectCopy, lineCopy, rectEmptyCopy, ellipseEmptyCopy, polygonEmptyCopy, rectFillCopy
    global ellipseFillCopy, polygonFillCopy, fillTxt, noTxt, fillRectCopy, pencilSize, markerSize, eraserSize, sprayPaintSize, textSize
    global calligraphySize, shapeSize, lineSize, sizes, tools, toolLabels, toolLabelRect, labelRectCopy, tool, shapeFormat
    global command, saveAs, filepath, saved, loaded, fill, signs, sp, calibriTxt, txt
    global newTxt, txtBox, drewBox, useOld, clickPt, starting, drawing, pts, sides, oldCanvas
    global pt, upArrow, downArrow, upArrow, downArrow, upRect, downRect, upArrowCopy, downArrowCopy, origMario
    global origLuigi, origPeach, origBowser, origRosalina, mario, luigi, peach, bowser, rosalina, origYoshi
    global origBowserJr, origPolari, origBabyLuma, origLubba, yoshi, bowserJr, polari, babyLuma, lubba, origCaptainToad
    global origBlueToad, origYellowToad, origBankToad, origMailToad, captainToad, blueToad, yellowToad, bankToad, mailToad, origPowerStar
    global origGrandStar, origGreenStar, origRedStar, origBronzeStar, powerStar, grandStar, greenStar, redStar, bronzeStar, origYellowLuma
    global origBlueLuma, origCoStarLuma, origRedLuma, origGreenLuma, yellowLuma, blueLuma, coStarLuma, redLuma, greenLuma, origSilverStar
    global origMarioSpinning, origMarioFlying, origMarioYoshiLuma, origFaceship, silverStar, marioSpinning, marioFlying, marioYoshiLuma, faceship, marioCopy
    global luigiCopy, peachCopy, bowserCopy, rosalinaCopy, yoshiCopy, bowserJrCopy, polariCopy, babyLumaCopy, lubbaCopy, captainToadCopy
    global blueToadCopy, yellowToadCopy, bankToadCopy, mailToadCopy, powerStarCopy, grandStarCopy, greenStarCopy, redStarCopy, bronzeStarCopy, yellowLumaCopy
    global blueLumaCopy, coStarLumaCopy, redLumaCopy, greenLumaCopy, silverStarCopy, marioSpinningCopy, marioFlyingCopy, marioYoshiLumaCopy, faceshipCopy, origMarioYoshi
    global origLuigiYoshi, marioYoshi, luigiYoshi, origDashYoshi, origBeeMario, origBooMario, origRockMario, origSpringMario, origRainbowMario, origBlimpYoshi
    global origBulbYoshi, origFireMario, origIceMario, origCloudMario, origSpinMario, origFlyMario, dashYoshi, beeMario, booMario, rockMario
    global springMario, rainbowMario, blimpYoshi, bulbYoshi, fireMario, iceMario, cloudMario, spinMario, flyMario, stamps
    global originals, stampSurfaces, stampSection, stampTxtAreaCopy, stampTxt, stpWidth, click, sizeUp, sizeDown, divide
    global firstSqr, secondSqr, thirdSqr, fourthSqr, fifthSqr, squares, resetIcon, dashPepper, beeMushroom, booMushroom
    global rockMushroom, springMushroom, rainbowStar, blimpFruit, bulbBerry, fireFlower, iceFlower, cloudFlower, spinDrill, redFlyStar
    global powerUps, powerUpScales, powerUpBlit, powerUpRect, powerUpRectCopy, riding, backgroundIcon, backgroundIcon
    global chooseTxt, backgroundTxt, backgroundRect, backgroundRectCopy, choosing, marioFloating, marioInSpace, marioRidingSeed, gatewayGalaxy, gatewayScene
    global toyTime, airshipArmada, bowserCastle, spaceClouds, blueGalaxy, redGalaxy, purplishGalaxy, spiralGalaxy, spaceMountains, fireIceEarth
    global backgrounds, leftArrow, rightArrow, checkmark, cancel, leftArrow, rightArrow
    ...
    global playRectCopy, playNextRectCopy, vlmRectCopy, songTitleRectCopy, pauseRectCopy, vlmTab, marioSpeech, lumaSpeech, speechBubble, marioSpeech
    global lumaSpeech, speechBubble, noLumaSpeech, marioSpeechCopy, lumaSpeechCopy, toolNames, marioToolInfo, stampNames, lumaSpeechInfo, running
    global starting
